...
hay que bajar 1.5 GB de whisper.cpp.
    ...
    ../.venv/Scripts/python.exe scripts/transcribe_fw.py public/audio/vo.mp3 public/captions.json
...
SOURCE = Path(sys.argv[1] if len(sys.argv) > 1 else "public/audio/vo.mp3")
